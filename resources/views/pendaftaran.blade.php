            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/pendaftaran/store">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="kategori" name="kategori">
                                    <option>IT-Venture</option>
                                    <option>Creativation Talk</option>
                                    <option>Dig-Up</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="telepon" class="col-md-4 col-form-label text-md-right">No. Telepon</label>

                            <div class="col-md-6">
                                <input id="telepon" type="text" class="form-control" name="telepon" value="{{ old('telepon') }}" required autocomplete="telepon" autofocus>
                            </div>
                        </div>
